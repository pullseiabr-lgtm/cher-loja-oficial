    ...
    <div id="sidebar" @click.self="reset"
        ...
        <div class="w-full max-w-xl h-screen overflow-x-hidden thin-scrolling bg-white ms-auto ltr:translate-x-full rtl:-translate-x-full">
            <div class="drawer-header">
                <h3 class="drawer-title">Seção de Categorias</h3>
...
export default {
    name: "CategorySectionCreateComponent",
    ...
    methods: {
        reset: function () {
            ...
            this.$store.dispatch("categorySection/reset").then().catch();
            this.errors = {};
        ...
        save: function () {
            try {
                const tempId = this.$store.getters["categorySection/temp"].temp_id;
